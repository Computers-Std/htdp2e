...
((modname Ex-215) (read-case-sensitive #t)
                  (teachpacks ())
...
;; Exercise 215. Design a world program that continually moves a
;; one-segment worm and enables a player to control the movement of
;; the worm with the four cardinal arrow keys. Your program should use
;; a red disk to render the one-and-only segment of the worm. For each
